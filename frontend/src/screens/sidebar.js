...
function Sidebar(){
    ...
    const [nav, setNav] = useState([
        ...
        {label: "My Exam", slug: "/discover", icon: "icon-ul"},
        {label: "Create Exam", slug: "/cates", icon: "icon-tag"},
        {label: "Exam Paper", slug: "/my-courses", icon: "icon-briefcase"}
    ])
    ...
    return (
        <div className="sidebar rel">
            <a className="logo bl">
                <img src={logo} className="bl" style={{height:"50pt"}}/>
            </a>
